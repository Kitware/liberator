...
Notes:
    ...
    cd ~/code/liberator/docs
    sphinx-apidoc --private -f -o ~/code/liberator/docs/source ~/code/liberator/liberator --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/liberator/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/liberator/versions/
"""
#
...
project = 'liberator'
copyright = '2023, joncrall'
author = 'joncrall'
modname = 'liberator'

modpath = join(dirname(dirname(dirname(__file__))), 'liberator', '__init__.py')
...
# html_logo = '.static/liberator.svg'
# html_favicon = '.static/liberator.ico'
...
latex_documents = [
    (master_doc, 'liberator.tex', 'liberator Documentation',
     'joncrall', 'manual'),
]
...
man_pages = [
    (master_doc, 'liberator', 'liberator Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'liberator', 'liberator Documentation',
     author, 'liberator', 'One line description of project.',
     'Miscellaneous'),
]
